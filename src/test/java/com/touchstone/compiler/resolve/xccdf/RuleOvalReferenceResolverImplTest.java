...
import com.touchstone.compiler.model.parsed.xccdf.ParsedCheckReference;
import com.touchstone.compiler.model.parsed.xccdf.ParsedComplexCheck;
...
class RuleOvalReferenceResolverImplTest {
    ...
    private ResolvedXccdfRule resolvedRule(String ruleId, String title, Object... nodes) {
        ...
        for (Object node : nodes) {
            checkNodes.add((com.touchstone.compiler.model.parsed.xccdf.ParsedCheckNode) node);
        }
    ...
    private ParsedComplexCheck complexCheck(String operator,
                                            com.touchstone.compiler.model.parsed.xccdf.ParsedCheckNode... children) {
